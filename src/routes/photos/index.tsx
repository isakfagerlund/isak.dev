  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-12 px-4 py-8 md:gap-16 md:px-6 md:py-12">
        ...
        <section className="rounded-3xl border border-dashed border-neutral-200 bg-neutral-50 p-4 md:p-6">
          ...
          <form className="mt-4 grid gap-3 md:grid-cols-[1fr_auto_auto] md:gap-4">
            <select
              disabled={!isAuthenticated}
              className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-2 text-sm text-neutral-600 disabled:cursor-not-allowed disabled:bg-neutral-100"
            >
            ...
            <input
              ...
              multiple
              disabled={!isAuthenticated}
              className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-2 text-sm text-neutral-600 file:mr-4 file:rounded-full file:border-0 file:bg-neutral-200 file:px-3 file:py-1 file:text-xs file:font-semibold file:uppercase file:text-neutral-700 disabled:cursor-not-allowed disabled:bg-neutral-100"
            />
            <button
              type="button"
              disabled={!isAuthenticated}
              className="w-full rounded-2xl bg-neutral-900 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-white disabled:cursor-not-allowed disabled:bg-neutral-300 md:w-auto"
            >
              Start upload
            </button>
          </form>
